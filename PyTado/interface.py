...
class Tado:
    ...
    def setZoneOverlay(self, zone, overlayMode, setTemp=None, duration=None, deviceType='HEATING', hotWaterPower=None):
        ...
        if hotWaterPower is not None:
            power = "ON" if hotWaterPower else "OFF"
            post_data["setting"] = {
                "type":"HOT_WATER",
                "power":power
            }
        elif setTemp is None:
            post_data["setting"] = {
                "type": deviceType,
                "power":"OFF"
            }
